...
//  typedef void  (*setExternalTime)(const time_t); // not used in this version
  ...
  // The following macros are used in calculating alarms and assume the clock is set
  // to a date later than Jan 1 1971. Always set the correct time before settting alarms.
